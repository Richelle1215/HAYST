...
<div class="bg-white shadow-lg rounded-xl max-w-6xl mx-auto p-10">
    ...
    <form method="POST" action="{{ route('seller.products.update', $product->id) }}" enctype="multipart/form-data">
        ...
        <div class="flex items-start justify-center" style="min-height: 540px;">
            {{-- ✅ Left: Product Image --}}
            ...
            <div class="w-3/4 pl-12">
                ...
                <div class="flex justify-end space-x-4 mt-8 pr-6">
                    ...
                    <button type="submit"
                            class="bg-blue-700 hover:bg-blue-800 text-white text-sm px-6 py-2.5 rounded-md shadow-md">
                        Update Product
                    </button>
                </div>
            </div>
