...
<head>
    ...
    <title>Seller Dashboard - LUMIÈRE</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="{{ route('seller.categories.index') }}" class="{{ request()->is('seller/categories*') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ route('seller.profile.index') }}" class="{{ request()->is('seller/profile*') ? 'active' : '' }}">
                    <span></span> Profile
                </a>
            </li>
        </ul>
