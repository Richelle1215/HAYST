        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="flex items-center mt-2">
                <label for="role_customer" class="inline-flex items-center mr-6">
                    <x-input id="role_customer" type="radio" wire:model="state.role" name="role" value="customer" required />
                    <span class="ml-2 text-sm text-gray-600">{{ __('Customer') }}</span>
                </label>

                <label for="role_seller" class="inline-flex items-center">
                    <x-input id="role_seller" type="radio" wire:model="state.role" name="role" value="seller" required />
