        ...
        <div class="bg-white border border-gray-200 p-6 rounded-lg mb-8">
            ...
            <form method="POST" action="{{ route('customer.profile.update') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $customer->name) }}" required autofocus autocomplete="name"
                ...
                <div class="mb-6">
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email', $customer->email) }}" required autocomplete="email"
                           class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    @error('email')
                        <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                    @enderror
